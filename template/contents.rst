...
#. If you find a change while reading through the web view, simply double-click on the text you'd like to edit in the web view. This will move to the same location in the code view, where you may now perform the desired edits. The syntax you see is `reST markup <https://dl.dropbox.com/u/2337351/rst-cheatsheet.html>`_ by `Sphinx <http://sphinx-doc.org/>`_. The items on the ``Help`` menu provide a convenient reference.
